...
bool loadMedia()
{
	...
	//Load dot texture
	if (!gDotTexture.loadFromFile("../../Media/images/Particle/red.bmp"))
	{
	...
	if (!gBGTexture.loadFromFile("../../Media/images/background.png"))
	{
	...
	else
	{
		...
		else
		{
			...
			while (!quit)
			{
				...
				camera.x = (dot.getPosX() + Dot::DOT_WIDTH/2) - SCREEN_WIDTH;
